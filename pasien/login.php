...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT * FROM pasien WHERE email = '$email' AND password = '$password'";
            ...
            <div class="container border rounded" style="margin-top: 10vw; padding: 5vw;">
                <form action="" method="post">
                    ...
                    <div class="d-grid gap-2 mx-auto">
                        <button type="submit" class="btn" name="submit" style="background-color: #8ECDB1;">Log In</button>
                    </div>
                    <p class="login-register-text"><a href="register.php" class="link-success">Sign In</a></p>
                </form>
            </div>
        </div>
