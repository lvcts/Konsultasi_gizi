    ...
    <div class="container-fluid">
        ...
        ?>
            ...
            <div class="button" style="margin-left: 2vw; margin-right: 2vw; margin-top: 1vw;">
                <div class="d-grid gap-2 mx-auto">
                    <a name="dlt" class="btn btn-danger" href="?delete&id_pasien=<?= $_SESSION['id_pasien'] ?>" onclick="return deletevalidate()">Delete</a>
                </div>
            </div>
        <?php
            $i++;
        ...
        if (isset($_GET['delete'])) {
            $sql = "DELETE FROM konsultasi WHERE id_pasien = " . $_GET['id_pasien'];
            $result = mysqli_query($conn, $sql);
            if ($result) {
